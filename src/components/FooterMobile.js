...
class FooterMobile extends Component {
  ...
  render() {
    ...
    return (
      <div className="page-footer mobile-page-footer">
        <div className="footer-container">
          <div className="footer-content mobile-footer-content">
            ...
            <div className="link-container mobile-footer-stay-tuned-container">
              <div className="social-container">
                ...
                <a href="https://twitter.com/sap" className="social-link social-link-mobile" title="twitter">
                  <img src={twitter} alt="twitter"></img>
                </a>
                <a href="https://www.youtube.com/user/SAP" className="social-link social-link-mobile" title="youtube">
                  <img src={youtube} alt="youtube"></img>
                </a>
                <a href="https://www.linkedin.com/company/sap/" className="social-link social-link-mobile" title="linkedin">
                  <img src={linkedin} alt="linkedin"></img>
                </a>
                <a href="mailto:?body=https%3A%2F%2Fwww.sap.com%2Fproducts%2Froadmaps.html?source=social-atw-mailto" className="social-link social-link-mobile" title="email">
